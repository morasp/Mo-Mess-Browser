   ...
   public class Sensor
    {
        ...
        public Sensor(String Name, String Address, int id, type t)
        {
            this.Type = t;
            this.name = Name;
        ...
        public static Sensor SensorFromByteArray(byte[] input, String ip)
        {
            byte[] a  =new byte[100];
            ...
            Sensor s  =new Sensor(Encoding.ASCII.GetString(a),ip,int.Parse(Encoding.ASCII.GetString(b)),t);
